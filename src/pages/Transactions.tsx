...
const Transactions: React.FC = () => {
    ...
    const handleDownload = () => alert("Download XLSX triggered");
    ...
    return (
        ...
        <div className="bg-white p-4 rounded-lg shadow mb-6">
                <div className="flex flex-col lg:flex-col xl:flex-row gap-4">
                    <div className="flex flex-col sm:flex-row gap-4 flex-1 flex-wrap">
                        ...
                        >
                            ...
                            <input
                                ...
                                className="w-full border border-black/30 rounded pl-10 px-3 py-2"
                            />
                        </div>
                        ...
                        <div className="relative flex-1 min-w-37.5">
                            <select
                                ...
                                className="w-full appearance-none border border-black/30 rounded px-3 py-2 pr-8"
                            >
                    ...
                    <div className="flex gap-2 w-full lg:w-auto flex-wrap lg:flex-nowrap items-center">
                        {/* Filter Button */}
                        <button
                            onClick={handleApplyFilters}
                            className="flex-1 xl:flex-none bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 transition font-medium"
                        >
                            Filter
                        </button>
                        ...
                        <button
                            ...
                            className="flex-1 xl:flex-none bg-gray-100 text-gray-500 px-6 py-2 rounded hover:text-gray-700 transition flex items-center justify-center gap-1"
                        >
                            <RxCross2 /> Clear
                        </button>
                        ...
                        <button
                            ...
                            className="flex-1 whitespace-nowrap xl:flex-none bg-green-500 text-white px-6 py-2 rounded shadow hover:opacity-90 transition font-medium"
                        >
                            Download XLSX
                        </button>
                    </div>
